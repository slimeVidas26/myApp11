...
export const ExpressPurchaseScreen=({route})=> {
   ...
   const [placeholder, setPlaceholder] = useState('route.params.title ');
    ...
    const startLoading = ()=> {
      ...
      const expressPurchaseRecommandation = async()=>{    
